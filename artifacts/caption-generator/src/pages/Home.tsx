...
import { Copy, RefreshCw, Send, BookOpen } from "lucide-react";
            ...
            {results.length === 0 ? (
              <Card className="flex flex-col items-center justify-center p-12 text-center border-dashed bg-muted/20 min-h-[420px]">
                ...
                <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
                  Enter a topic on the left and choose a voice. Your captions will appear here, rooted in the ancient tradition of the Tewahedo Church.
                </p>
              </Card>
            ) : (
